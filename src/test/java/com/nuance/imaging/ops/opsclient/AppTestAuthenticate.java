 ...
 */
public class AppTestAuthenticate 
    extends TestCase
{
	OPSService service;
     ...
     */
    public AppTestAuthenticate( String testName )
    {
        super( testName );
        ...
        this.service = (OPSService) beanFactory.getBean("serviceWithNTLM");
    }
    ...
    public void testOPSClient()
    {
        ...
        try {
			Thread.sleep(response.getEstimatedWorkTimeSec() * 1000 + 3);
